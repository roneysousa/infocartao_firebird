...
{      If (frmSeleCliente.Caption = 'Selecione o cliente') Then
      ...
      End;       }
      //
      If (frmSeleCliente.Caption = 'RELAÇÕES DE CARTÕES POR CLIENTE') Then
      begin
           Relatorio_CartoesCliente;
      End;
      //
      If (frmSeleCliente.Caption = 'APRESENTAÇÃO DO CARTÃO') Then
      begin
      ...
      begin
           ...
           //
           //Application.CreateForm(TfrmRelAviso, frmRelAviso);   //Carrega form na memória
           //
           With dmRelatorios.dstClientesRel do
           begin
                DisableControls;
      ...
      begin
           ...
           begin
                ...
                txtRelatorio.Caption := 'RELATÓRIO.: FICHA DE CLIENTE';
...
begin
         ...
         //
         {Application.CreateForm(TfrmRelCartoesCliente, frmRelCartoesCliente);   //Carrega form na memória
         //
         frmRelCartoesCliente.txtEmpresa.Caption := uPrincipal.M_NMEMPR;
         frmRelCartoesCliente.txtSistema.Caption := 'NETCARTÃO - ADMINISTRAÇÃO DE CARTÃO DE CRÉDITO';
         frmRelCartoesCliente.txtRelatorio.Caption := 'RELAÇÃO DE CARTÕES POR CLIENTE';
...
begin
      frmPrincipal.StatusBar1.Panels[1].Text := 'Digite o código ou nome do cliente.';
end;
...
{      If (frmSeleCliente.Caption = 'Selecione o cliente') Then
      ...
      begin
           ...
           With frmRelAviso do
           begin
              memAviso.Lines.Add('       Não registramos o pagamento de sua fatura, do '
                                     ...
                                     +#13+'       Por esse motivo, cumprindo acordo firmado com'
                                         +' Câmara dos Diretores Lojista - CDL, em 15(quinze) dias, a'
                                         +' contar recebimento desta, estaremos encaminhado seu nome'
                                         +' para o cadastro do SPC - Serviço de Proteção ao Crédito.'+#13
                                     +#13+'       Caso já tenha pago, fineza descosiderar este aviso.');
      ...
      begin
           ...
           //dmInfoCartao.cdsBuscaCliente.Cancel;
           //
           Application.CreateForm(TfrmRelReciboMod3, frmRelReciboMod3);  // Carrega form na memória
           //
           ...
           begin
                memRecibo.Lines.Add('       Eu, '+frmRelReciboMod3.cdsBuscaClienteCLI_NMCLIE.Value+', recebi da Rádio'
                                   +'Táxi Transporte e Comunicacões Ltda., um Cartão de'
                                   +'Crédito, personalizado com meus dados, e uma cópia'
                                   +'do Contrato de Utilização do Cartão Rádio Táxi    '
                                   +'222-2222.');
                txtMes.Caption := uFuncoes.DataExtenso(Date()) ;
                //
      ...
      begin
           ...
           //dmInfoCartao.cdsBuscaCliente.Cancel;
           //
           Application.CreateForm(TfrmRelApresCartao, frmRelApresCartao);   // Carrega form na memória
