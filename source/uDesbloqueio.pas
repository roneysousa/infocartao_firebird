...
begin
     ...
     begin
          ...
          begin
             Application.MessageBox('Registro de cartão não se encontra-se bloqueado!',
                         'ATENÇÂO', MB_OK+MB_ICONINFORMATION);
             edtNRCART.Clear;
             edtNRCART.SetFocus;
             pnlDados.Visible := False;
             lbl_Vali.Visible := False;
     ...
     Else
     begin
          Application.MessageBox('Registro de cartão ou validade inválido!',
                    'ATENÇÂO', MB_OK+MB_ICONSTOP);
          edtNRCART.Clear;
          edtNRCART.SetFocus;
     End;
end;
...
begin
     ...
     begin
          If Application.MessageBox('Confirma desbloqueio de cartão?',
          ...
          begin
               ...
               //
               ShowMessage('Registro de cartão desbloqueado!');
               pnlDados.Visible := False;
               //
               lbl_Vali.Visible := False;
               dbeVALI.Visible := False;
