object frmEnvelope: TfrmEnvelope
  Left = 188
  Top = 107
  ...
  object Panel4: TPanel
    ...
    object GridBoleto: TDBGrid
      ...
      TitleFont.Style = []
      OnCellClick = GridBoletoCellClick
      OnDblClick = GridBoletoDblClick
      OnKeyDown = GridBoletoKeyDown
      OnKeyPress = GridBoletoKeyPress
      Columns = <
        item
          Expanded = False
  ...
  object ravEnvelope: TRvProject
    Engine = RvSystem1
    ProjectFile = 'C:\INFOG2\Cartao\Rave\prvEnvelope.rav'
    Left = 16
    Top = 309
  end
  ...
  object dscClientesEnvelope: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = dmRelatorios.dstEnvelopesClientes
    Left = 88
    Top = 305
  end
end
